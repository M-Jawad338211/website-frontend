  ...
  return (
    <div className="App">
      ...
      <div className="flex flex-wrap justify-center gap-4 px-4 md:px-0 mt-8">
        <div className=" group hover-gradient bg-gray-100 p-4 h-auto w-full sm:w-48 rounded-md flex items-start transform transition duration-300 hover:shadow-lg hover:scale-y-125 origin-top">
      ...
      <div className='flex justify-center pr-16 mt-8'>
        <div >
          <img className='h-64 w-64 hover:bg-slate-300 rounded-lg' src="Group47.png" alt="group47" />
        </div>
        <div>
          <img className='h-64 w-64 pl-16 hover:bg-slate-300 rounded-lg' src="Group48.png" alt="group48" />
        </div>
        <div>
          <img className='h-64 w-64 pl-16 hover:bg-slate-300 rounded-lg' src="Group49.png" alt="group48" />
        </div>
      </div>
...
customers, and growing overall sales. </p>
      ...
      <footer className="relative flex bg-cover bg-center h-80 w-full mt-[-45px] px-32 text-white" style={{ backgroundImage: 'url(./footer.png)' }}>
